    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-300 text-lg">Find out exactly how much you need to retire at 50 — and whether you are on track to get there.</p>
        </div>
        ...
        {calculated && result && (
          <div className="mt-8 bg-gray-900 rounded-2xl p-8 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-slate-800 rounded-xl p-4">
                <p className="text-gray-300 text-sm">Projected at 50</p>
            ...
            <div className={`rounded-xl p-6 ${result.onTrack ? "bg-green-900/40 border border-green-700" : "bg-red-900/40 border border-red-700"}`}>
              {result.onTrack ? (
                <><p className="text-green-400 font-semibold text-lg">You are on track to retire at 50!</p><p className="text-gray-400 text-xs mt-2">Results are in today&apos;s dollars.</p></>
              ) : (
                <div>
        ...
        <div className="mt-16 space-y-8">
          ...
          <p className="text-gray-300 leading-relaxed">One major advantage of retiring at 50 versus 40 or 45 is the Rule of 55. If you leave your job in or after the year you turn 55, you can withdraw from your current employer 401(k) without the 10% early withdrawal penalty. This gives you penalty-free access to a major account much sooner than the Roth conversion ladder requires. Combined with a taxable brokerage and Roth IRA contributions, this makes age 50 a particularly tax-efficient retirement target.</p>

          <h3 className="text-xl font-semibold">Catch-Up Contributions After 50</h3>
          <p className="text-gray-300 leading-relaxed">If you are currently in your 40s planning for a 50 retirement, note that the IRS allows catch-up contributions starting at age 50: an extra $7,500 to your 401(k) and an extra $1,000 to your IRA annually (2024 figures). This accelerates the final push to your FIRE number significantly.</p>

          <h3 className="text-xl font-semibold">Healthcare: The 15-Year Bridge to Medicare</h3>
          <p className="text-gray-300 leading-relaxed">Retiring at 50 means 15 years before Medicare at 65. Healthcare costs are the most significant planning variable for early retirees in the US. ACA marketplace plans with income-based subsidies are the most common solution — at low withdrawal rates, your effective income can be low enough to qualify for significant subsidies. Budget $500-$1,200/month per person conservatively, and consider this a core part of your FIRE number planning.</p>

          <div className="mt-12 space-y-6">
            <script type="application/ld+json" dangerouslySetInnerHTML={{__html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much money do I need to retire at 50?","acceptedAnswer":{"@type":"Answer","text":"Using the 4% rule, you need 25x your annual expenses. For $50,000/year spending, that is $1,250,000. For $60,000/year, you need $1,500,000. Many people planning a 40-year retirement target 28x expenses for extra safety, meaning $1,400,000 for $50k spending."}},{"@type":"Question","name":"Can I retire at 50 with $1 million?","acceptedAnswer":{"@type":"Answer","text":"Yes, if your annual spending is $40,000 or less. At the 4% rule, $1,000,000 supports $40,000/year. This is very comfortable in low cost-of-living areas and many countries outside the US. If you spend more, you need a larger portfolio or plan to earn some income in early retirement."}},{"@type":"Question","name":"What is the difference between retiring at 50 vs 65?","acceptedAnswer":{"@type":"Answer","text":"Retiring at 50 gives you 15 extra years of freedom - potentially the best years of your health and energy. The tradeoff is a larger required portfolio (40-year vs 25-year retirement), no access to Medicare until 65, no Social Security until 62 at earliest, and more years of investment risk to manage."}},{"@type":"Question","name":"Is 50 too old to start planning for early retirement?","acceptedAnswer":{"@type":"Answer","text":"If you are already 45-49, retiring at 50 may be very tight unless you have significant savings. However, even aggressive saving in your late 40s can dramatically improve your retirement timeline. Use our calculator to see your realistic target date based on your current situation."}},{"@type":"Question","name":"How does retiring at 50 affect Social Security?","acceptedAnswer":{"@type":"Answer","text":"Retiring at 50 with no further earned income means your Social Security benefit will be lower than if you worked until 62 or 67. However, you can still claim at 62 (reduced benefit) or 67 (full benefit) or 70 (maximum benefit). Most FIRE planners treat Social Security as a bonus and do not rely on it in their core calculations."}}]}`}} />
            <h2 className="text-2xl font-bold">Frequently Asked Questions</h2>
            <div className="space-y-4">
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">How much money do I need to retire at 50?</h4>
                <p className="text-gray-300 text-sm">Using the 4% rule, you need 25x your annual expenses. For $50,000/year spending, that is $1,250,000. For $60,000/year, you need $1,500,000. Many people planning a 40-year retirement target 28x expenses for extra safety, meaning $1,400,000 for $50k spending.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">Can I retire at 50 with $1 million?</h4>
                <p className="text-gray-300 text-sm">Yes, if your annual spending is $40,000 or less. At the 4% rule, $1,000,000 supports $40,000/year. This is very comfortable in low cost-of-living areas and many countries outside the US. If you spend more, you need a larger portfolio or plan to earn some income in early retirement.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">What is the difference between retiring at 50 vs 65?</h4>
                <p className="text-gray-300 text-sm">Retiring at 50 gives you 15 extra years of freedom — potentially the best years of your health and energy. The tradeoff is a larger required portfolio (40-year vs 25-year retirement), no access to Medicare until 65, no Social Security until 62 at earliest, and more years of investment risk to manage.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">Is 50 too old to start planning for early retirement?</h4>
                <p className="text-gray-300 text-sm">If you are already 45-49, retiring at 50 may be very tight unless you have significant savings. However, even aggressive saving in your late 40s can dramatically improve your retirement timeline. Use our calculator to see your realistic target date based on your current situation.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">How does retiring at 50 affect Social Security?</h4>
                <p className="text-gray-300 text-sm">Retiring at 50 with no further earned income means your Social Security benefit will be lower than if you worked until 62 or 67. However, you can still claim at 62 (reduced benefit) or 67 (full benefit) or 70 (maximum benefit). Most FIRE planners treat Social Security as a bonus and do not rely on it in their core calculations.</p>
              </div>
            </div>
          </div>
