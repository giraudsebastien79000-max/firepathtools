    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-400 text-lg">Calculate your Financial Independence number in pounds and find out how many years until you can retire early in the UK.</p>
        ...
        <div className="bg-gray-900 rounded-2xl p-8 space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-2">Monthly Contributions (£)</label>
        ...
        {result && (
          <div className="mt-8 bg-gray-900 rounded-2xl p-8 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-gray-800 rounded-xl p-4">
                <p className="text-gray-400 text-sm">FIRE Age</p>
                <p className="text-2xl font-bold text-white">{result.fireAge}</p>
              </div>
              <div className="bg-gray-800 rounded-xl p-4">
                <p className="text-gray-400 text-sm">Withdrawal Rate</p>
        ...
        <div className="mt-16 space-y-8">
          ...
          <p className="text-gray-400 leading-relaxed">The 4% rule is based on US market data going back to 1926. UK market returns have historically been slightly lower and more volatile. A 3.5% safe withdrawal rate (SWR) is commonly used by UK FIRE practitioners to account for this, as well as the longer retirement horizons that come with retiring in your 30s, 40s, or 50s. At 3.5%, your FIRE number is approximately 28.6x your annual expenses.</p>

          <h3 className="text-xl font-semibold">How Much Do You Need to Retire Early in the UK?</h3>
          <p className="text-gray-400 leading-relaxed">At a 3.5% withdrawal rate, the formula is simple: FIRE Number = Annual Expenses × 28.6. If you spend £25,000 per year, your target is £715,000. If you spend £30,000, you need £857,000. If you spend £40,000, your target is £1,143,000. Use the calculator above to get your personalised number based on your current age, savings, and contributions.</p>
