      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        {calculated && result && (
          <div className="mt-8 bg-gray-900 rounded-2xl p-8 space-y-4">
            ...
            <div className={`rounded-xl p-6 ${result.onTrack ? "bg-green-900/40 border border-green-700" : "bg-red-900/40 border border-red-700"}`}>
              {result.onTrack ? (
                <><p className="text-green-400 font-semibold text-lg">You are on track to retire at 45!</p><p className="text-gray-400 text-xs mt-2">Results are in today&apos;s dollars.</p></>
              ) : (
                <div>
        ...
        <div className="mt-16 space-y-8">
          ...
          <div className="mt-12 space-y-6">
            <script type="application/ld+json" dangerouslySetInnerHTML={{__html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do I need to retire at 45?","acceptedAnswer":{"@type":"Answer","text":"Using the 4% rule, you need 25x your annual expenses. If you spend $50,000/year, your target is $1,250,000. For a longer retirement horizon, many people target 28x expenses ($1,400,000 for $50k/year spending) as a safety buffer."}},{"@type":"Question","name":"Can I retire at 45 with $2 million?","acceptedAnswer":{"@type":"Answer","text":"Yes - $2,000,000 supports $80,000/year in spending at the 4% rule. This is a comfortable retirement in most US cities and an excellent income in lower cost-of-living areas or abroad. With a 3.5% withdrawal rate for safety, $2M supports $70,000/year."}},{"@type":"Question","name":"What is the best investment strategy to retire at 45?","acceptedAnswer":{"@type":"Answer","text":"The FIRE community consensus is simple: maximize contributions to tax-advantaged accounts (401k, Roth IRA, HSA), then invest the rest in a taxable brokerage. Use low-cost index funds - total market (VTI/VTSAX) and international (VXUS) - with expense ratios under 0.1%. Avoid market timing and stay invested through downturns."}},{"@type":"Question","name":"Is retiring at 45 too early?","acceptedAnswer":{"@type":"Answer","text":"Not financially - the math works if you hit your number. The bigger question is purpose and identity. Many people who retire at 45 find that they want structure, social connection, or a sense of contribution. Barista FIRE (part-time meaningful work) or passion projects solve this while also reducing portfolio withdrawal pressure."}},{"@type":"Question","name":"How does Social Security factor in when retiring at 45?","acceptedAnswer":{"@type":"Answer","text":"If you retire at 45 with minimal additional earned income, your Social Security benefit will be reduced compared to working until 62 or 67. However, many early retirees plan conservatively and treat any Social Security income as a bonus. Check your Social Security statement at ssa.gov to see your projected benefit."}}]}`}} />
