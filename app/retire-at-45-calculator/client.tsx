    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-400 text-lg">Find out exactly how much you need to retire at 45 — and whether you are on track to get there.</p>
        </div>
        ...
        <div className="mt-16 space-y-8">
          ...
          <div className="bg-gray-900 rounded-2xl p-6 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div className="text-gray-400">Age 25</div><div className="text-white">Start investing, maximize 401(k) match</div>
              <div className="text-gray-400">Age 30</div><div className="text-white">Target $100k-$150k saved</div>
              <div className="text-gray-400">Age 35</div><div className="text-white">Target $300k-$400k saved</div>
              <div className="text-gray-400">Age 40</div><div className="text-white">Target $600k-$800k saved</div>
              <div className="text-gray-400">Age 45</div><div className="text-white">FIRE number reached — retire!</div>
            </div>
          </div>

          <h3 className="text-xl font-semibold">Retiring at 45 vs Retiring at 40</h3>
          <p className="text-gray-400 leading-relaxed">The extra 5 years make a significant difference. At 7% annual returns, money roughly doubles every 10 years. Starting at 25, by 45 you have 20 years of compounding versus 15 years for the age-40 target. This means you need roughly 40% less in monthly contributions to reach the same portfolio value — making it accessible to a much wider group of people.</p>

          <h3 className="text-xl font-semibold">Tax Strategy for Early Retirement at 45</h3>
          <p className="text-gray-400 leading-relaxed">At 45, you still face the challenge of accessing tax-advantaged retirement accounts before the standard age of 59½. The Roth conversion ladder (converting traditional IRA funds to Roth, then withdrawing after 5 years) is the most common strategy. Rule 72(t) SEPP (Substantially Equal Periodic Payments) is another option, though less flexible. Having a substantial taxable brokerage account bridges the gap in early years.</p>

          <h3 className="text-xl font-semibold">Healthcare Planning When Retiring at 45</h3>
          <p className="text-gray-400 leading-relaxed">Healthcare is typically the largest unexpected expense for early retirees in the US. At 45, you have 20 years before Medicare eligibility at 65. Options include ACA marketplace plans (income-based subsidies can be significant at low withdrawal levels), COBRA from your last employer (expensive but temporary), or part-time work with benefits. Budget $6,000-$18,000 per year for a family.</p>
          ...
          <div className="mt-12 space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-gray-900 rounded-xl p-6">
                ...
                <p className="text-gray-400 text-sm">Using the 4% rule, you need 25x your annual expenses. If you spend $50,000/year, your target is $1,250,000. For a longer retirement horizon, many people target 28x expenses ($1,400,000 for $50k/year spending) as a safety buffer.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">Can I retire at 45 with $2 million?</h4>
                <p className="text-gray-400 text-sm">Yes — $2,000,000 supports $80,000/year in spending at the 4% rule. This is a comfortable retirement in most US cities and an excellent income in lower cost-of-living areas or abroad. With a 3.5% withdrawal rate for safety, $2M supports $70,000/year.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">What is the best investment strategy to retire at 45?</h4>
                <p className="text-gray-400 text-sm">The FIRE community consensus is simple: maximize contributions to tax-advantaged accounts (401k, Roth IRA, HSA), then invest the rest in a taxable brokerage. Use low-cost index funds — total market (VTI/VTSAX) and international (VXUS) — with expense ratios under 0.1%. Avoid market timing and stay invested through downturns.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">Is retiring at 45 too early?</h4>
                <p className="text-gray-400 text-sm">Not financially — the math works if you hit your number. The bigger question is purpose and identity. Many people who retire at 45 find that they want structure, social connection, or a sense of contribution. Barista FIRE (part-time meaningful work) or passion projects solve this while also reducing portfolio withdrawal pressure.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">How does Social Security factor in when retiring at 45?</h4>
                <p className="text-gray-400 text-sm">If you retire at 45 with minimal additional earned income, your Social Security benefit will be reduced compared to working until 62 or 67. However, many early retirees plan conservatively and treat any Social Security income as a bonus. Check your Social Security statement at ssa.gov to see your projected benefit.</p>
              </div>
            </div>
          </div>
