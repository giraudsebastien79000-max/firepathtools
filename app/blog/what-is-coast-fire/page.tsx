...
export default function Page() {
  return (
    <article className="max-w-3xl mx-auto px-4 py-16 prose prose-invert">
      ...
      <p>A 30-year-old who invests $150,000 today and never contributes another dollar will have roughly $827,000 by age 65 — assuming a 5% average annual return. They did not save that $677,000 difference. Time did.</p>
      <h2>A Real Example</h2>
      <p>David is 34. He works in project management and wants to retire at 62 with $1,200,000.</p>
      <p>Coast Number = $1,200,000 divided by (1.05)^28 = roughly $306,000</p>
      <p>If David has $306,000 invested today and never adds another dollar, compound interest will grow it to $1,200,000 by age 62. He still needs to work — but only to cover his current expenses. The retirement savings problem is already solved.</p>
      ...
      <p><strong>Example:</strong> $1,000,000 divided by (1.05)^30 = $231,377</p>
      ...
      <p>The earlier you start, the faster you get there. Put $150 a month away at 24, keep it for 38 years at 5% real — you end up with around $194,000 of today's money. Same $150. Just time. Now imagine what happens if you invest $300 a month instead — you end up with roughly twice as much.</p>
      <h2>FAQ</h2>
