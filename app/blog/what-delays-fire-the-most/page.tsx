    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">Most people who discover FIRE never actually reach it. Not because the math does not work — it does. But because six specific obstacles add years, sometimes decades, to the timeline. Here is what they are, how much they cost you, and what to do about each one.</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">The single biggest delay to FIRE is a low savings rate caused by high expenses relative to income. Everything else — investment fees, inflation, low returns, starting late — adds years at the margin. But the savings rate gap is what kills most FIRE timelines before they start.</p>
          </div>

          <h2 className="text-2xl font-bold">1. A Low Savings Rate</h2>
          <p className="text-gray-300 leading-relaxed">Your savings rate is the most powerful variable in the entire FIRE equation. Not your income. Not your investment returns. Your savings rate determines both how fast your portfolio grows and — because lower expenses mean a lower FIRE number — how much you actually need to accumulate.</p>

          <div className="bg-gray-900 rounded-2xl p-6">
            <h4 className="font-semibold text-orange-400 mb-3">Savings Rate vs Years to FIRE (starting from zero, 5% real return)</h4>
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div className="text-gray-300">10% savings rate</div><div className="text-white">~51 years</div>
              <div className="text-gray-300">20% savings rate</div><div className="text-white">~37 years</div>
              <div className="text-gray-300">30% savings rate</div><div className="text-white">~28 years</div>
          ...
          <p className="text-gray-300 leading-relaxed">Going from a 20% to a 40% savings rate cuts your timeline nearly in half — from 37 years to 22 years. That is 15 years of your life. The math is not incremental; it is exponential. And unlike investment returns, your savings rate is something you directly control.</p>
          <p className="text-gray-300 leading-relaxed">The most common reason for a low savings rate is not low income — it is lifestyle inflation. As income rises, spending tends to rise proportionally, leaving the savings rate flat. This is the trap that keeps high earners stuck on the same 30-year timeline as average earners.</p>

          <h2 className="text-2xl font-bold">2. Starting Too Late</h2>
          <p className="text-gray-300 leading-relaxed">Compound interest is brutally front-loaded. The money you invest at 25 does far more work than the money you invest at 35, because it has 10 extra years of compounding. The cost of a 10-year delay is not 10 years of missed contributions — it is 10 years of compounding on every dollar you would have had.</p>

          <div className="bg-gray-900 rounded-2xl p-6">
            <h4 className="font-semibold text-orange-400 mb-3">The Cost of a 10-Year Delay</h4>
            <div className="space-y-3 text-sm">
              <div className="grid grid-cols-2 gap-2">
                <div className="text-gray-300">Start at 25, invest $500/month at 5% real</div>
                <div className="text-white">Portfolio at 65: ~$763,000</div>
              </div>
              <div className="grid grid-cols-2 gap-2">
                <div className="text-gray-300">Start at 35, invest $500/month at 5% real</div>
                <div className="text-white">Portfolio at 65: ~$416,000</div>
              </div>
              <div className="text-gray-300 mt-2">The 10-year delay costs $347,000 — even though you only missed $60,000 in contributions.</div>
            </div>
          </div>

          <p className="text-gray-300 leading-relaxed">This is why the FIRE community consistently emphasizes starting immediately over starting optimally. An imperfect portfolio started today beats a perfect portfolio started in three years by a margin that cannot be recovered.</p>

          <h2 className="text-2xl font-bold">3. High Investment Fees</h2>
          <p className="text-gray-300 leading-relaxed">Investment fees are the silent killer of FIRE timelines. A 1% annual fee sounds trivial — it is not. On a $500,000 portfolio growing at 5% real, the difference between a 0.05% expense ratio (Vanguard index fund) and a 1% fee (many actively managed funds) is approximately $218,000 over 20 years. You are paying $218,000 for underperformance.</p>
          <p className="text-gray-300 leading-relaxed">The research is consistent: the vast majority of actively managed funds underperform low-cost index funds over 15+ year periods, after fees. The FIRE community's near-universal preference for index funds — VTSAX, VTI, FSKAX — is not ideology. It is arithmetic.</p>

          <div className="bg-gray-900 rounded-2xl p-6">
            <h4 className="font-semibold text-orange-400 mb-3">Fee Impact on a $500k Portfolio Over 20 Years (5% real gross return)</h4>
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div className="text-gray-300">0.05% expense ratio</div><div className="text-white">~$1,314,000</div>
              <div className="text-gray-300">0.5% expense ratio</div><div className="text-white">~$1,206,000</div>
              <div className="text-gray-300">1.0% expense ratio</div><div className="text-white">~$1,096,000</div>
              <div className="text-gray-300">Cost of 1% vs 0.05%</div><div className="text-red-400">~$218,000 lost</div>
            </div>
          </div>

          <h2 className="text-2xl font-bold">4. Lifestyle Inflation</h2>
          <p className="text-gray-300 leading-relaxed">Lifestyle inflation — spending more as you earn more — is the most insidious FIRE delay because it feels like progress. You got a raise, so you moved to a nicer apartment. You got a promotion, so you bought a new car. Your income doubled but your savings rate stayed the same. From a FIRE perspective, nothing changed.</p>
          <p className="text-gray-300 leading-relaxed">The FIRE community calls this "keeping up with the Joneses" and it is the primary reason high-income professionals often have worse FIRE timelines than lower-income disciplined savers. A teacher saving 40% of $60,000 will reach FIRE before a consultant saving 10% of $200,000 — because the savings rate matters more than the income.</p>
          <p className="text-gray-300 leading-relaxed">The antidote is a deliberate "savings rate first" approach: every time your income increases, direct at least 50% of the raise to savings before adjusting lifestyle. This keeps the savings rate rising rather than flat.</p>

          <h2 className="text-2xl font-bold">5. Sequence of Returns Risk (in reverse)</h2>
          <p className="text-gray-300 leading-relaxed">Most people know about sequence of returns risk in retirement — the danger of a market crash in the early years of drawdown. But there is an accumulation phase version: a major market crash in the years just before you planned to retire can push your FIRE date back by 3-7 years, even if you stay invested.</p>
          <p className="text-gray-300 leading-relaxed">The 2008-2009 financial crisis delayed many FIRE timelines by 5+ years. The 2000-2002 dot-com crash did the same. The protection against this is not market timing — it is building a portfolio large enough that a 30-40% drawdown still leaves you at or near your FIRE number, and having the flexibility to work 1-2 more years if markets are down at your target date.</p>

          <h2 className="text-2xl font-bold">6. Not Having a Specific FIRE Number</h2>
          <p className="text-gray-300 leading-relaxed">This one sounds simple but it is more common than you think. People who know their exact FIRE number — down to the dollar — save more aggressively, make better financial decisions, and reach FIRE faster than people who have a vague goal of "enough to retire comfortably." Specificity creates urgency.</p>
          <p className="text-gray-300 leading-relaxed">Without a specific number, people tend to move the goalposts. They hit $500,000 and decide they need $750,000. They hit $750,000 and decide they need $1,000,000. They never feel like they have "enough" because they never defined what enough was. The 4% rule gives you a concrete, research-backed number to aim for — and that clarity alone measurably improves FIRE outcomes.</p>
          ...
          <div className="mt-12 bg-gray-900 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <Link href="/tools/investment-fees" className="flex items-center justify-between bg-slate-800 rounded-xl p-4 hover:bg-gray-700 transition-colors">
