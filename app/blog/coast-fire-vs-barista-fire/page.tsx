          ...
          <div className="mt-12 space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-900 rounded-xl p-6">
                ...
                <p className="text-gray-300 text-sm">It depends on your FIRE number and how many years until traditional retirement. Use our <Link href="/tools/coast-fire" className="text-orange-400 hover:underline">Coast FIRE calculator</Link> to find your exact number based on your age, target retirement age, and expected return rate.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
