    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">Both Coast FIRE and Barista FIRE offer a middle path between grinding full-time and full early retirement. But they work very differently — and choosing the wrong one can derail your financial independence timeline.</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-gray-400">You have already saved enough that your portfolio will grow to your FIRE number on its own — without any new contributions. You can stop investing and work just enough to cover living expenses.</p>
              </div>
              <div>
                <p className="font-semibold text-white mb-2">Barista FIRE</p>
                <p className="text-gray-400">You have a partially funded portfolio that covers most of your expenses, but you work part-time — often for benefits like healthcare — to cover the gap without drawing down your investments.</p>
              </div>
            </div>
          </div>

          <h2 className="text-2xl font-bold">What Is Coast FIRE?</h2>
          <p className="text-gray-400 leading-relaxed">Coast FIRE is reached when your current investment portfolio is large enough that, left alone to compound at a historical rate of return (typically 7% real), it will grow to your full FIRE number by traditional retirement age (usually 60-65) — without you ever adding another dollar.</p>
          <p className="text-gray-400 leading-relaxed">Once you hit your Coast FIRE number, you have effectively "pre-funded" your retirement. The compounding does the rest of the work. At that point, you only need to earn enough to cover your current living expenses — no more mandatory savings. This unlocks an enormous amount of career flexibility: you can downshift to a lower-paying but more meaningful job, go part-time, take a sabbatical, or move somewhere with a lower cost of living.</p>

          <div className="bg-gray-900 rounded-2xl p-6">
            <h3 className="font-semibold text-orange-400 mb-3">Coast FIRE Formula</h3>
            <p className="text-gray-400 text-sm mb-3">Coast FIRE Number = FIRE Number / (1 + r)^n</p>
            <p className="text-gray-400 text-sm">Where r = annual return rate and n = years until traditional retirement age.</p>
            <p className="text-gray-400 text-sm mt-2">Example: FIRE number of $1,000,000, 30 years to retirement, 7% return → Coast number = $1,000,000 / (1.07)^30 = $131,367</p>
          </div>

          <p className="text-gray-400 leading-relaxed">The key insight is that Coast FIRE can be reached much earlier than full FIRE because you only need a fraction of your final target. Someone who needs $1,000,000 to fully retire might only need $130,000-$200,000 to coast there — depending on their timeline. This makes Coast FIRE an achievable milestone in your early 30s for many disciplined savers.</p>

          <h2 className="text-2xl font-bold">What Is Barista FIRE?</h2>
          <p className="text-gray-400 leading-relaxed">Barista FIRE gets its name from the idea of leaving a high-stress career and taking a part-time job — like a barista at a coffee shop — that provides just enough income and, crucially, employer-sponsored health insurance. The portfolio covers the bulk of living expenses, and the part-time income fills the gap.</p>
          <p className="text-gray-400 leading-relaxed">Unlike Coast FIRE, Barista FIRE does not require that your portfolio be fully self-sufficient. Instead, your investments partially cover your expenses, and you supplement with earned income. The portfolio is typically already being drawn down (partially), but more slowly than it would be in full retirement — preserving it for the long term.</p>
          ...
          <p className="text-gray-400 leading-relaxed">Barista FIRE is especially popular in the United States where healthcare costs are a major barrier to full early retirement. A part-time job at companies like Starbucks, Trader Joe's, or REI — all known for offering benefits to part-time workers — can provide health insurance that would otherwise cost $500-$1,500/month on the open market.</p>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="space-y-2">
                <tr className="border-b border-gray-800">
                  <td className="py-3 pr-4 text-gray-400">Portfolio status</td>
                ...
                <tr className="border-b border-gray-800">
                  <td className="py-3 pr-4 text-gray-400">Work required</td>
          ...
          <p className="text-gray-400 leading-relaxed">The right choice depends on where you are in your FIRE journey, your age, and your healthcare situation.</p>
          ...
          <div className="mt-12 space-y-4">
            ...
            <div className="space-y-4">
              <div className="bg-gray-900 rounded-xl p-6">
                ...
                <p className="text-gray-400 text-sm">Not exactly. Semi-retirement usually means reducing work hours while still saving. Coast FIRE specifically means you have stopped mandatory saving — your portfolio will reach your FIRE number through compounding alone. You still work, but only to cover current expenses.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">How much do I need for Coast FIRE?</h4>
                <p className="text-gray-400 text-sm">It depends on your FIRE number and how many years until traditional retirement. Use our Coast FIRE calculator to find your exact number based on your age, target retirement age, and expected return rate.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">Does Barista FIRE mean working at a coffee shop?</h4>
                <p className="text-gray-400 text-sm">Not literally — the name comes from Starbucks being one of the first major companies known for offering benefits to part-time workers. Barista FIRE means any part-time work that covers income gaps and/or provides benefits. Many Barista FIRE practitioners work in retail, consulting, freelancing, or passion projects.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">Which has a higher portfolio requirement — Coast or Barista FIRE?</h4>
                <p className="text-gray-400 text-sm">Barista FIRE typically requires a much larger portfolio because you are partially drawing it down to cover expenses. Coast FIRE can be achieved with a much smaller portfolio because you are not touching it — just letting it compound over decades.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">What is the difference between Barista FIRE and Lean FIRE?</h4>
                <p className="text-gray-400 text-sm">Lean FIRE means fully retiring on a very small portfolio by keeping expenses extremely low (typically under $25,000/year). Barista FIRE means partially retiring with a larger portfolio supplemented by part-time income. Lean FIRE is full retirement; Barista FIRE involves continued work.</p>
              </div>
            </div>
          </div>
