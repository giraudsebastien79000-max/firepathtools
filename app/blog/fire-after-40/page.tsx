    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">Most FIRE content assumes you discovered it at 25. But the majority of people who find financial independence do so in their 30s, 40s, or even 50s. If you are starting late, you have not missed the boat — you have just changed the destination slightly.</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <div className="mt-12 bg-gray-900 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <Link href="/blog/middle-class-fire" className="flex items-center justify-between bg-gray-800 rounded-xl p-4 hover:bg-gray-700 transition-colors">
