...
export const metadata: Metadata = {
 ...
 description:
 'How much you actually need to retire in Portugal, which visa to use, and how the numbers stack up for FIRE savers from the US, UK, Canada, and Australia.',
 openGraph: {
 title: 'Retire in Portugal: The Complete FIRE Guide (2026)',
 description:
 'How much you actually need to retire in Portugal, which visa to use, and how the numbers stack up for FIRE savers from the US, UK, Canada, and Australia.',
...
export default function RetireInPortugal() {
 ...
 This guide breaks down what it actually costs, which visa route fits a FIRE lifestyle,
 and how to think about the numbers before you start packing.
 </p>
 ...
 Costs vary enormously by region, so treat these as planning ranges rather than promises:
 </p>
 <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden mb-6">
 <table className="w-full text-left">
 <thead>
 <tr className="border-b border-gray-800">
 <th className="p-4 text-sm font-semibold uppercase tracking-wide text-gray-400">Lifestyle</th>
 <th className="p-4 text-sm font-semibold uppercase tracking-wide text-gray-400">Monthly budget (single, incl. rent)</th>
 </tr>
 </thead>
 <tbody className="text-gray-300">
 <tr className="border-b border-gray-800">
 <td className="p-4">Inland town (Braga, Coimbra, Viseu, Aveiro)</td>
 <td className="p-4 text-white font-semibold">EUR1,300-EUR1,800</td>
 </tr>
 <tr className="border-b border-gray-800">
 <td className="p-4">Porto or Algarve town</td>
 <td className="p-4 text-white font-semibold">EUR1,500-EUR2,200</td>
 </tr>
 <tr>
 <td className="p-4">Lisbon</td>
 <td className="p-4 text-white font-semibold">EUR1,800-EUR2,600+</td>
 </tr>
 </tbody>
 </table>
 </div>
