...
export const metadata: Metadata = {
  ...
  description: "Waiting just one year to start investing can cost you $40,000 or more by retirement. See the real numbers behind the cost of delay — and why starting imperfectly beats waiting for perfect.",
}
    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">Most people think the difference between starting to invest at 25 versus 26 is one year of contributions. It is not. It is often $40,000 or more — and that gap compounds every year you wait.</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <div className="bg-gray-900 rounded-2xl p-6 border border-orange-500/30">
            ...
            <p className="text-gray-300 text-sm mb-4">Investing $500/month at 5% annual return:</p>
            <div className="grid grid-cols-1 gap-3 text-sm">
              <div className="flex justify-between items-center border-b border-slate-600 pb-2">
                ...
                <span className="text-white font-bold">$763,000</span>
              </div>
              <div className="flex justify-between items-center border-b border-slate-600 pb-2">
                <span className="text-gray-300">Start at 26 → portfolio at 65</span>
                <span className="text-white font-bold">$720,000</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-red-400">Cost of waiting one year</span>
                <span className="text-red-400 font-bold">$43,000</span>
              </div>
            </div>
          </div>

          <p className="text-gray-300 leading-relaxed">You did not lose $6,000 in contributions (12 months × $500). You lost $43,000 — because that first year of invested money had 40 years to compound instead of 39. The math of compounding is not linear. Every year of delay costs more than the previous year, because the base portfolio is larger.</p>

          <h2 className="text-2xl font-bold">Why One Year Costs So Much</h2>
          <p className="text-gray-300 leading-relaxed">Compound interest works by applying your return not just to your contributions, but to all previous growth as well. At 5% real, money roughly doubles every 14 to 15 years. This means $1,000 invested at 25 grows to about $7,000 by 65. The same $1,000 invested at 26 reaches only about $6,700 by 65 — a few hundred dollars less over a single year. Multiply that across 12 months of $500 contributions, and the gap is the $43,000 shown above.</p>
          ...
          <div className="bg-gray-900 rounded-2xl p-6">
            <h4 className="font-semibold text-orange-400 mb-4">$500/month at 5% annual return, retire at 65</h4>
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between items-center border-b border-slate-600 pb-2">
                ...
                <span className="text-white font-bold">$568,000</span>
              </div>
              <div className="flex justify-between items-center border-b border-slate-600 pb-2">
                <span className="text-gray-300">Start at 35 (10-year delay)</span>
                <span className="text-white font-bold">$416,000</span>
              </div>
              <div className="flex justify-between items-center border-b border-slate-600 pb-2">
                <span className="text-red-400">Cost of 5-year delay</span>
                <span className="text-red-400 font-bold">$195,000</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-red-400">Cost of 10-year delay</span>
                <span className="text-red-400 font-bold">$347,000</span>
              </div>
            </div>
          </div>

          <p className="text-gray-300 leading-relaxed">A 10-year delay costs $347,000 — even though you only missed $60,000 in contributions. The compounding on those early contributions is worth more than five times their face value over a full career. This is not a rounding error. This is the core mechanic of wealth building, and most people never see it laid out this clearly.</p>
          ...
          <p className="text-gray-300 leading-relaxed">These reasons feel rational. But they share a common flaw: they treat the cost of waiting as zero. It is not zero. As shown above, every year of delay has a specific, calculable dollar cost — one that compounds into the future. The decision to wait is not a neutral decision. It is a decision to pay $43,000 (or more) for the privilege of starting later.</p>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Approximate cost: $100,000-$150,000 in lost compounding</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 mt-0.5">→</span>
                <div>
                  ...
                  <p className="text-gray-300">Approximate cost: $35,000-$50,000 in lost compounding</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 mt-0.5">→</span>
                <div>
                  ...
                  <p className="text-gray-300">Approximate cost: $75,000-$95,000 in lost compounding</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 mt-0.5">→</span>
          ...
          <div className="mt-12 space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-900 rounded-xl p-6">
                ...
                <p className="text-gray-300 text-sm">No — starting at 40 still gives you 20-25 years of compounding before traditional retirement age. $1,000/month at 5% from age 40 to 65 produces approximately $595,000. It is less than starting at 25, but far better than not starting at all. The best time to start was yesterday; the second best time is today.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
