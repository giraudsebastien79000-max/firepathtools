    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">Most people think the difference between starting to invest at 25 versus 26 is one year of contributions. It is not. It is often $100,000 or more — and that gap compounds every year you wait.</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <div className="bg-gray-900 rounded-2xl p-6 border border-orange-500/30">
            ...
            <p className="text-gray-400 text-sm mb-4">Investing $500/month at 7% annual return:</p>
            <div className="grid grid-cols-1 gap-3 text-sm">
              <div className="flex justify-between items-center border-b border-gray-700 pb-2">
                <span className="text-gray-400">Start at 25 → portfolio at 65</span>
                <span className="text-white font-bold">$1,311,000</span>
              </div>
              <div className="flex justify-between items-center border-b border-gray-700 pb-2">
                <span className="text-gray-400">Start at 26 → portfolio at 65</span>
          ...
          <div className="bg-gray-900 rounded-2xl p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center border-b border-gray-700 pb-2">
                <span className="text-gray-400">Start at 25</span>
                <span className="text-white font-bold">$1,311,000</span>
              </div>
              <div className="flex justify-between items-center border-b border-gray-700 pb-2">
                <span className="text-gray-400">Start at 30 (5-year delay)</span>
                <span className="text-white font-bold">$910,000</span>
              </div>
              <div className="flex justify-between items-center border-b border-gray-700 pb-2">
                <span className="text-gray-400">Start at 35 (10-year delay)</span>
          ...
          <p className="text-gray-400 leading-relaxed">A 10-year delay costs $690,000 — even though you only missed $60,000 in contributions. The compounding on those early contributions is worth more than ten times their face value over a full career. This is not a rounding error. This is the core mechanic of wealth building, and most people never see it laid out this clearly.</p>

          <h2 className="text-2xl font-bold">The "I'll Start When I'm Ready" Trap</h2>
          <p className="text-gray-400 leading-relaxed">The most common reason people delay investing is that they are waiting until conditions are perfect. Waiting until they pay off their student loans. Waiting until they get a raise. Waiting until the market is less volatile. Waiting until they understand investing better. Waiting until after the holidays.</p>
          <p className="text-gray-400 leading-relaxed">These reasons feel rational. But they share a common flaw: they treat the cost of waiting as zero. It is not zero. As shown above, every year of delay has a specific, calculable dollar cost — one that compounds into the future. The decision to wait is not a neutral decision. It is a decision to pay $93,000 (or more) for the privilege of starting later.</p>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Approximate cost: $250,000-$350,000 in lost compounding</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 mt-0.5">→</span>
                <div>
                  ...
                  <p className="text-gray-400">Approximate cost: $80,000-$120,000 in lost compounding</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 mt-0.5">→</span>
                <div>
                  ...
                  <p className="text-gray-400">Approximate cost: $170,000-$200,000 in lost compounding</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 mt-0.5">→</span>
                <div>
                  ...
                  <p className="text-gray-400">Research shows timing the market consistently underperforms staying invested</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <p className="text-gray-400 leading-relaxed">If money is tight, the goal is not to wait until you can invest a meaningful amount. The goal is to start with whatever you can — even $50/month — and increase it over time. The psychological habit of investing is as valuable as the financial return in the early years. People who start with small amounts and increase gradually consistently save more over their lifetime than people who wait to start big.</p>
          <p className="text-gray-400 leading-relaxed">Open the account. Buy the index fund. Automate the contribution. Do it today, not when conditions are right — because conditions will never be perfectly right, and every month you wait has a specific dollar cost attached to it.</p>
          ...
          <div className="mt-12 bg-gray-900 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <Link href="/tools/compound-interest" className="flex items-center justify-between bg-gray-800 rounded-xl p-4 hover:bg-gray-700 transition-colors">
