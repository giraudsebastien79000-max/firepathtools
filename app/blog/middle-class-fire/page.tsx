    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <p className="text-gray-300 leading-relaxed">Middle-Class FIRE is not an official FIRE category like Lean FIRE or Fat FIRE — it is a framing for the millions of people who earn average or slightly above-average incomes and want to pursue financial independence without the extreme frugality of Lean FIRE or the extreme income of Fat FIRE.</p>
          <p className="text-gray-300 leading-relaxed">The typical Middle-Class FIRE household earns $60,000-$120,000, owns a home (or plans to), may have children, and wants to retire in their late 40s or early 50s rather than at 35 or 40. They are not trying to hack the system or live in a van. They are trying to build a comfortable life and exit the workforce a decade or two earlier than most people.</p>
          ...
          <p className="text-gray-300 leading-relaxed">For middle-class earners, tax optimization is more impactful than for high earners because every dollar saved in taxes is a larger percentage of income. Max your 401(k) ($23,500 in 2025), max a Roth IRA ($7,000), and if eligible, use an HSA as a triple-tax-advantaged account. These three accounts alone can shelter $30,000-$35,000/year from taxes — often the entire investable savings for a middle-class household.</p>

          <h3 className="text-xl font-semibold">The Dual-Income Advantage</h3>
          <p className="text-gray-300 leading-relaxed">Two middle-class incomes accelerate FIRE dramatically. A household earning $140,000 combined ($70,000 each) with a 35% savings rate saves $49,000/year — enough to reach $1,000,000 in approximately 14 years. DINK (Dual Income No Kids) households have some of the fastest FIRE timelines regardless of individual income level.</p>

          <h3 className="text-xl font-semibold">The "One More Year" Trap — and How to Avoid It</h3>
          <p className="text-gray-300 leading-relaxed">Middle-class FIRE practitioners are particularly vulnerable to "one more year" syndrome — always finding a reason to work a little longer before retiring. The solution is a specific, pre-committed FIRE number and date. When you hit the number, you retire. Building a small buffer (10-15% above your calculated FIRE number) helps psychologically without adding years of unnecessary work.</p>

          <h3 className="text-xl font-semibold">Coast FIRE as a Middle-Class Strategy</h3>
          <p className="text-gray-300 leading-relaxed">Coast FIRE is particularly powerful for middle-class families. Once you accumulate enough that your portfolio will grow to your FIRE number without new contributions, you can radically reduce financial pressure. You can take a less stressful job, reduce hours, or pivot careers — without derailing retirement. For a family earning $80,000, Coast FIRE might be reachable at $200,000-$300,000 in investments in their early 30s.</p>
          ...
          <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div><p className="text-white font-medium">Calculate your exact FIRE number</p><p className="text-gray-300">Annual retirement expenses × 25 (at 4% rule)</p></div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 font-bold mt-0.5">2.</span>
                <div><p className="text-white font-medium">Max all tax-advantaged accounts first</p><p className="text-gray-300">401(k), Roth IRA, HSA — in that order</p></div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 font-bold mt-0.5">3.</span>
                <div><p className="text-white font-medium">Invest the rest in a taxable brokerage</p><p className="text-gray-300">Low-cost index funds — VTI, VXUS, BND</p></div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 font-bold mt-0.5">4.</span>
                <div><p className="text-white font-medium">Track your savings rate monthly</p><p className="text-gray-300">30%+ is the Middle-Class FIRE target</p></div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 font-bold mt-0.5">5.</span>
                <div><p className="text-white font-medium">Identify your Coast FIRE number</p><p className="text-gray-300">Hit it and reduce financial pressure immediately</p></div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-orange-400 font-bold mt-0.5">6.</span>
                <div><p className="text-white font-medium">Plan healthcare before you need it</p><p className="text-gray-300">Model ACA costs at different income levels</p></div>
              </div>
            </div>
          </div>

          <h2 className="text-2xl font-bold">What Middle-Class FIRE Actually Looks Like</h2>
          <p className="text-gray-300 leading-relaxed">The most common middle-class FIRE outcome is not retiring at 40 with zero income. It is retiring from a demanding career at 50-55, with a paid-off home, $1.2M-$2M in investments, and the option to do part-time or consulting work that is interesting rather than necessary. It is financial independence without the extreme — and for most middle-class families, it is completely achievable with consistent, intentional saving over 20-25 years.</p>
          ...
          <div className="mt-12 space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-900 rounded-xl p-6">
                ...
                <p className="text-gray-300 text-sm">Yes, but the timeline adjusts. Children add expenses during the accumulation phase and may increase your FIRE number. A realistic target for a middle-class family with two children and a mortgage might be FIRE at 52-58 rather than 45-50. That is still a decade or more before traditional retirement — and a dramatically different quality of life.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">What savings rate do I need for Middle-Class FIRE?</h4>
                <p className="text-gray-300 text-sm">A 25-35% savings rate is the typical Middle-Class FIRE target. Below 20%, the timeline extends beyond 30 years. Above 40%, you start approaching early-retirement territory (45-50). The exact rate depends on your income, expenses, and target retirement age.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
