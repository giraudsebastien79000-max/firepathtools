        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="border px-4 py-2 text-left">Est. Annual Income</th>
              <th className="border px-4 py-2 text-left">FIRE Number (25x)</th>
            </tr>
          </thead>
          <tbody>
            <tr><td className="border px-4 py-2">Elon Musk</td><td className="border px-4 py-2">$56B</td><td className="border px-4 py-2">$1.4 Trillion</td></tr>
            <tr><td className="border px-4 py-2">Jeff Bezos</td><td className="border px-4 py-2">$8B</td><td className="border px-4 py-2">$200 Billion</td></tr>
            <tr><td className="border px-4 py-2">Mark Zuckerberg</td><td className="border px-4 py-2">$1B</td><td className="border px-4 py-2">$25 Billion</td></tr>
            <tr><td className="border px-4 py-2">Tim Cook</td><td className="border px-4 py-2">$50M</td><td className="border px-4 py-2">$1.25 Billion</td></tr>
            <tr><td className="border px-4 py-2">Taylor Swift</td><td className="border px-4 py-2">$150M</td><td className="border px-4 py-2">$3.75 Billion</td></tr>
            <tr><td className="border px-4 py-2">LeBron James</td><td className="border px-4 py-2">$120M</td><td className="border px-4 py-2">$3 Billion</td></tr>
            <tr><td className="border px-4 py-2">Cristiano Ronaldo</td><td className="border px-4 py-2">$125M</td><td className="border px-4 py-2">$3.1 Billion</td></tr>
            <tr><td className="border px-4 py-2">Warren Buffett</td><td className="border px-4 py-2">$100M</td><td className="border px-4 py-2">$2.5 Billion</td></tr>
            <tr><td className="border px-4 py-2">Oprah Winfrey</td><td className="border px-4 py-2">$80M</td><td className="border px-4 py-2">$2 Billion</td></tr>
            <tr><td className="border px-4 py-2">Kim Kardashian</td><td className="border px-4 py-2">$80M</td><td className="border px-4 py-2">$2 Billion</td></tr>
            <tr><td className="border px-4 py-2">Kylie Jenner</td><td className="border px-4 py-2">$60M</td><td className="border px-4 py-2">$1.5 Billion</td></tr>
            <tr><td className="border px-4 py-2">Rihanna</td><td className="border px-4 py-2">$70M</td><td className="border px-4 py-2">$1.75 Billion</td></tr>
            <tr><td className="border px-4 py-2">Jay-Z</td><td className="border px-4 py-2">$50M</td><td className="border px-4 py-2">$1.25 Billion</td></tr>
