    ...
    <main className="min-h-screen bg-gray-950 text-white px-4 py-16">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">31 free calculators to plan your path to FIRE. No signup. No ads. Just tools that work.</p><p className="mt-4"><a href="/tools" className="text-orange-400 font-semibold hover:text-orange-300">View all 31 calculators &rarr;</a></p>
        </div>
