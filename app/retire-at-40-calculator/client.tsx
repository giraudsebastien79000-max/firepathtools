      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mt-16 space-y-8">
          ...
          <div className="mt-12 space-y-6">
            <script type="application/ld+json" dangerouslySetInnerHTML={{__html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Can you retire at 40 with $1 million?","acceptedAnswer":{"@type":"Answer","text":"Yes, if your annual expenses are $40,000 or less. The 4% rule allows you to withdraw $40,000 per year from a $1,000,000 portfolio. However, given the length of a potential 50-year retirement, many advisors suggest targeting $1.25M-$1.5M for extra safety margin."}},{"@type":"Question","name":"How much do I need to save per month to retire at 40?","acceptedAnswer":{"@type":"Answer","text":"It depends on your starting age and expenses. A 25-year-old starting from zero targeting $1,000,000 at 40 needs to save approximately $3,750/month at 5% annual returns after inflation. Use the calculator above to get your personalized number."}},{"@type":"Question","name":"What investments should I use to retire at 40?","acceptedAnswer":{"@type":"Answer","text":"Most FIRE practitioners use low-cost index funds: VTSAX or VTI for US stocks, VXUS for international diversification, and BND for bonds as retirement approaches. The goal is maximum diversification at minimum cost - expense ratios below 0.1%."}},{"@type":"Question","name":"What happens to healthcare if I retire at 40?","acceptedAnswer":{"@type":"Answer","text":"Healthcare is one of the biggest challenges for early retirees in the US. Options include ACA marketplace plans (often subsidized at low income levels), a health-sharing ministry, or part-time work with benefits. Budget $500-$1,500/month for a family depending on your situation."}},{"@type":"Question","name":"Is the 4% rule safe for a 50-year retirement?","acceptedAnswer":{"@type":"Answer","text":"Historical data suggests yes, but with less certainty than for 30 years. Many early retirees use a 3.5% or 3.25% withdrawal rate for longer horizons, or plan to earn some income in early retirement to reduce portfolio pressure."}}]}`}} />
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-900 rounded-xl p-6">
                ...
                <p className="text-gray-300 text-sm">It depends on your starting age and expenses. A 25-year-old starting from zero targeting $1,000,000 at 40 needs to save approximately $3,750/month at 5% annual returns after inflation. Use the calculator above to get your personalized number.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
