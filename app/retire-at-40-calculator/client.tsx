    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-400 text-lg">Find out exactly how much you need to retire at 40 — and whether you are on track to get there.</p>
        </div>
        ...
        <div className="mt-16 space-y-8">
          ...
          <p className="text-gray-400 leading-relaxed">Retiring at 40 is one of the most ambitious goals in the FIRE movement — Financial Independence, Retire Early. It requires aggressive saving, smart investing, and a clear plan starting in your 20s. This calculator gives you the exact number you need and tells you whether your current savings rate will get you there.</p>

          <h3 className="text-xl font-semibold">What Is the FIRE Number for Retiring at 40?</h3>
          <p className="text-gray-400 leading-relaxed">Your FIRE number is the total portfolio value you need to safely withdraw from indefinitely. Based on the 4% rule — backed by the Trinity Study — you need 25 times your annual expenses. If you spend $40,000 per year, your target is $1,000,000. If you spend $60,000, you need $1,500,000.</p>
          <p className="text-gray-400 leading-relaxed">The 4% rule states that you can withdraw 4% of your portfolio annually, adjusted for inflation, and have a very high probability of your money lasting 30+ years. For a 40-year retirement horizon (retiring at 40 and living to 80+), many FIRE experts recommend a slightly more conservative 3.5% withdrawal rate — meaning 28x your expenses.</p>

          <h3 className="text-xl font-semibold">What Savings Rate Do You Need?</h3>
          <p className="text-gray-400 leading-relaxed">The math is straightforward but demanding. To retire at 40 starting from zero at age 20, assuming 7% annual returns, you need to save approximately 50-60% of your take-home income. Most people pursuing this goal combine a high income with very low lifestyle inflation — living on $30,000-$40,000 while earning $80,000-$150,000+.</p>
          ...
          <div className="bg-gray-900 rounded-2xl p-6 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div className="text-gray-400">25% savings rate</div><div className="text-white">~32 years</div>
          ...
          <div className="mt-12 space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-gray-900 rounded-xl p-6">
                ...
                <p className="text-gray-400 text-sm">Yes, if your annual expenses are $40,000 or less. The 4% rule allows you to withdraw $40,000 per year from a $1,000,000 portfolio. However, given the length of a potential 50-year retirement, many advisors suggest targeting $1.25M-$1.5M for extra safety margin.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">How much do I need to save per month to retire at 40?</h4>
                <p className="text-gray-400 text-sm">It depends on your starting age and expenses. A 25-year-old starting from zero targeting $1,000,000 at 40 needs to save approximately $3,500/month at 7% annual returns. Use the calculator above to get your personalized number.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">What investments should I use to retire at 40?</h4>
                <p className="text-gray-400 text-sm">Most FIRE practitioners use low-cost index funds: VTSAX or VTI for US stocks, VXUS for international diversification, and BND for bonds as retirement approaches. The goal is maximum diversification at minimum cost — expense ratios below 0.1%.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">What happens to healthcare if I retire at 40?</h4>
                <p className="text-gray-400 text-sm">Healthcare is one of the biggest challenges for early retirees in the US. Options include ACA marketplace plans (often subsidized at low income levels), a health-sharing ministry, or part-time work with benefits. Budget $500-$1,500/month for a family depending on your situation.</p>
              </div>
              <div className="bg-gray-900 rounded-xl p-6">
                <h4 className="font-semibold mb-2">Is the 4% rule safe for a 50-year retirement?</h4>
                <p className="text-gray-400 text-sm">Historical data suggests yes, but with less certainty than for 30 years. Many early retirees use a 3.5% or 3.25% withdrawal rate for longer horizons, or plan to earn some income in early retirement to reduce portfolio pressure.</p>
              </div>
            </div>
          </div>
