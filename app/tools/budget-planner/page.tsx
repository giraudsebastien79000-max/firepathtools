            ...
            <div className="space-y-4">
              <div className="bg-gray-800 rounded-xl p-5 border border-orange-400/30">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between"><span className="text-gray-300 text-sm">50% Needs</span><span className="text-white font-bold">${result.needs.toLocaleString("en-US",{maximumFractionDigits:0})}</span></div>
                  <div className="flex justify-between"><span className="text-gray-300 text-sm">30% Wants</span><span className="text-white font-bold">${result.wants.toLocaleString("en-US",{maximumFractionDigits:0})}</span></div>
                  <div className="flex justify-between"><span className="text-gray-300 text-sm">20% Savings</span><span className="text-orange-400 font-bold">${result.savings.toLocaleString("en-US",{maximumFractionDigits:0})}</span></div>
                </div>
              </div>
              <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
                <p className="text-gray-400 text-xs font-semibold uppercase tracking-widest mb-4">60/20/20 FIRE Aggressive</p>
                <div className="space-y-3">
                  <div className="flex justify-between"><span className="text-gray-300 text-sm">60% Needs</span><span className="text-white font-bold">${result.needsAlt.toLocaleString("en-US",{maximumFractionDigits:0})}</span></div>
                  <div className="flex justify-between"><span className="text-gray-300 text-sm">20% Wants</span><span className="text-white font-bold">${result.wantsAlt.toLocaleString("en-US",{maximumFractionDigits:0})}</span></div>
                  <div className="flex justify-between"><span className="text-gray-300 text-sm">20% Savings</span><span className="text-orange-400 font-bold">${result.savingsAlt.toLocaleString("en-US",{maximumFractionDigits:0})}</span></div>
                </div>
              </div>
            </div>
          )}
