    ...
    <main className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center px-4 py-16">
      <div className="max-w-xl w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-300 text-base">The 50/30/20 rule is the simplest framework to build wealth. See your ideal budget in seconds.</p>
        </div>
          ...
          {done && (
            <div className="space-y-4">
              ...
              <div className="bg-slate-800 rounded-xl p-5 border border-slate-600">
                <p className="text-gray-300 text-xs font-semibold uppercase tracking-widest mb-4">60/20/20 FIRE Aggressive</p>
                <div className="space-y-3">
