    ...
    <main className="min-h-screen bg-gray-950 text-white px-4 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6 bg-gray-900 rounded-2xl p-6 mb-8">
          ...
          <div>
            <label className="block text-sm text-gray-300 mb-1">Expected Annual Return (%)</label>
          ...
          <div>
            ...
            <input type="number" value={inflationRate} onChange={e => setInflationRate(Number(e.target.value))} className="w-full bg-slate-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-orange-500" />
          </div>
        </div>
