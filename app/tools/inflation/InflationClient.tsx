    ...
    <main className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center px-4 py-16">
      <div className="max-w-xl w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-300 text-base">See how inflation erodes your purchasing power over time -- and why investing beats holding cash.</p>
        </div>
        <div className="bg-gray-900 rounded-2xl p-8 space-y-6 border border-gray-800">
          ...
          {result !== null && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-800 rounded-xl p-5 border border-orange-400/30 text-center">
                  <p className="text-gray-300 text-xs mb-1">Cost in {years} years</p>
                ...
                <div className="bg-red-900/20 rounded-xl p-5 border border-red-400/30 text-center">
                  <p className="text-gray-300 text-xs mb-1">Purchasing power lost</p>
