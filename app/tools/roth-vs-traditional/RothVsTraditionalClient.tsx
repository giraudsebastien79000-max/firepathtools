    ...
    <main className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center px-4 py-16">
      <div className="max-w-xl w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-300 text-base">Find out which retirement account wins for your specific tax situation.</p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-800 rounded-xl p-4 border border-slate-600 text-center">
                  ...
                  <p className="text-gray-300 text-xs mb-1">Balance at retirement</p>
                  <p className="text-lg font-bold text-white">${result.rothValue.toLocaleString("en-US", { maximumFractionDigits: 0 })}</p>
                  <p className="text-gray-300 text-xs mt-2 mb-1">After-tax value</p>
