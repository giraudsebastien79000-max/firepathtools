    ...
    <main className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center px-4 py-16">
      <div className="max-w-xl w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-300 text-base">See exactly how much fees are silently stealing from your retirement portfolio.</p>
        </div>
          ...
          {result !== null && (
            <div className="space-y-4">
              <div className="bg-red-900/20 rounded-xl p-6 text-center border border-red-400/30">
                <p className="text-gray-300 text-sm mb-1">Total Lost to Fees</p>
                <p className="text-5xl font-bold text-red-400">${result.feeCost.toLocaleString("en-US", { maximumFractionDigits: 0 })}</p>
                <p className="text-gray-300 text-sm mt-2">That is {result.feePct.toFixed(1)}% of your potential wealth gone.</p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-800 rounded-xl p-4 border border-slate-600 text-center">
                  <p className="text-gray-300 text-xs mb-1">Without Fees</p>
