    ...
    <main className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center px-4 py-16">
      <div className="max-w-xl w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-300 text-base">Find out exactly how much you need in your emergency fund before investing.</p>
        </div>
          ...
          {result !== null && (
            <div className="space-y-4">
              <div className={`rounded-xl p-6 text-center border ${result.funded ? "bg-green-900/30 border-green-400/30" : "bg-slate-800 border-orange-400/30"}`}>
                <p className="text-gray-300 text-sm mb-1">Target Emergency Fund</p>
                ...
                {result.funded ? (
                  ...
                  <p className="text-gray-300 text-sm mt-3">You still need ${result.gap.toLocaleString("en-US", { maximumFractionDigits: 0 })} to reach your goal.</p>
                )}
              </div>
